...
-- Tiempo de generación: 26-03-2026 a las 15:15:11
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `ver_empleados_memorandos` ()   BEGIN
  SELECT CONCAT(e.nombre,' ',e.apellido) AS nombreCompleto,
         m.id_memorando, m.descripcion
  FROM empleado e
  JOIN memorando m ON e.id_empleado = m.id_empleado;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `ver_empleados_permisos` ()   BEGIN
  SELECT CONCAT(e.nombre,' ',e.apellido) AS nombreCompleto,
         p.fecha_inicio, p.descripcion, p.estado
  FROM permiso p
...
INSERT INTO `empleado` (`id_empleado`, `nombre`, `apellido`, `documento`, `telefono`, `direccion`, `correo`, `fecha_inicio_contrato`, `fecha_fin_contrato`, `estado`, `id_horario`, `id_cargo`) VALUES
(1, 'Juan', 'Perez', 1010, 2147483647, 'Calle 1', 'juan@gmail.com', '2024-01-10', NULL, 'Activo', 1, 1),
(2, 'Maria', 'Lopez', 1020, 300222222, 'Calle 2', 'maria@gmail.com', '2023-05-15', NULL, 'Activo', 2, 1),
(3, 'Carlos', 'Gomez', 1030, 300333333, 'Calle 3', 'carlos@gmail.com', '2024-02-20', NULL, 'Activo', 3, 2),
(4, 'Ana', 'Martinez', 1040, 300444444, 'Calle 4', 'ana@gmail.com', '2026-01-01', NULL, 'Activo', 5, 3),
(5, 'Luis', 'Rodriguez', 1050, 300555555, 'Calle 5', 'luis@gmail.com', '2023-03-12', NULL, 'Activo', 7, 4),
(6, 'Pedro', 'Ramirez', 1060, 300666666, 'Calle 6', 'pedro@gmail.com', '2021-07-01', NULL, 'Activo', 8, 4),
(7, 'Andres', 'Lopez', 1080, 300888888, 'Calle 7', 'andres@gmail.com', '2025-01-01', NULL, 'Activo', 9, 5),
(8, 'Sofia', 'Morales', 1100, 302123456, 'Calle 8', 'sofia@gmail.com', '2024-06-01', NULL, 'Activo', 6, 3),
(9, 'Camila', 'Diaz', 1200, 303456789, 'Calle 9', 'camila@gmail.com', '2023-09-10', NULL, 'Activo', 4, 2),
(10, 'David', 'Torres', 1300, 304567890, 'Calle 10', 'davidto@gmail.com', '2022-08-20', NULL, 'Activo', 2, 1),
(11, 'Carlos', 'Ramírez', 2000, 310000000, 'Oficina principal', 'admin@operpan.com', '2026-01-01', NULL, 'Activo', 10, 6);
...
INSERT INTO `horario` (`id_horario`, `jornada`, `descripcion`, `id_cargo`) VALUES
(1, '4:00 AM - 2:00 PM', 'Turno mañana meseros', 1),
(2, '1:30 PM - 11:00 PM', 'Turno tarde meseros', 1),
(3, '4:00 AM - 2:00 PM', 'Turno mañana cajero', 2),
(4, '1:30 PM - 11:00 PM', 'Turno tarde cajero', 2),
(5, '4:00 AM - 2:00 PM', 'Preparación desayuno y almuerzo', 3),
(6, '7:00 AM - 5:00 PM', 'Producción continua cocina', 3),
(7, '5:00 AM - 2:00 PM', 'Producción de pan temprano', 4),
(8, '1:00 PM - 10:00 PM', 'Reposición y producción tarde', 4),
(9, '7:00 AM - 5:00 PM', 'Producción y decoración pastelería', 5),
(10, '8:00 AM - 6:00 PM', 'Horario administrativo', 6);
...
(1, 1, '2026-03-01', '2026-03-05', '2026-03-06', 'Cita médica', 'Aprobado'),
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vista_empleado_horario`  AS SELECT `e`.`id_empleado` AS `id_empleado`, concat(`e`.`nombre`,' ',`e`.`apellido`) AS `nombre_completo`, `h`.`jornada` AS `jornada` FROM (`empleado` `e` join `horario` `h` on(`e`.`id_horario` = `h`.`id_horario`)) ;
...
--
ALTER TABLE `horario`
  ADD CONSTRAINT `horario_ibfk_1` FOREIGN KEY (`id_cargo`) REFERENCES `cargo` (`id_cargo`);
